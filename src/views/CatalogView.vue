...
const cars = [
    ...
    car(3, 'MITSUBISHI', 'Outlander', 'SUV', 'Automatic', 12000, 2014, 90000, 'Mers.png'),
    ...
    car(8, 'PORSCHE', 'Panamera', 'Hatchback', 'Automatic', 30000, 2017, 36000,'Mers.png'),
    ...
    car(11, 'MINI', 'Cabrio', 'Convertiable', 'Automatic', 15000, 2019, 40000, 'Mers.png'),
