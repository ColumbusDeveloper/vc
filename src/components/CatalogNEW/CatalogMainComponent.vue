        ...
        >
            ...
            <div class="ma-mo__global-search-and-card-box">
                    ...
                    <div class="ma-mo__card-box ma-mo__card-box-calc" v-if="showcalculated">
                        ...
                        v-for="car in calculatedcars" :key="car"
                        :car="car"
                        @passtocarpage="getPassCarPageItem"
                        >
...
<script>
    ...
    // import carpage from '@/components/CatalogNEW/CarPage.vue'
    import Headerone from '@/components/CatalogNEW/CarPage.vue'
    import burgerbtn from '@/components/CatalogNEW/CarPage.vue'
    import burgerlist from '@/components/CatalogNEW/CarPage.vue'
