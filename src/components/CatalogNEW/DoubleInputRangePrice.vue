  ...
  export default {
    ...
    data() {
      return {
        ...
        minPrice:1,//модель для инпута, ответственного за минимальное значение, устанавливается в методе findStartEndOfInputsArrOfInputs ()
        maxPrice:10,//модель для инпута, ответственного за максимальное значение, устанавливается в методе findStartEndOfInputsArrOfInputs ()
